...
echo     - 이름: imseungjun-profile
echo     - Public
echo     - README, .gitignore, license 는 추가하지 마세요 (비어 있어야 합니다)
echo.
start "" "https://github.com/new?name=imseungjun-profile&visibility=public"
...
git remote add origin "https://github.com/imseungjun/imseungjun-profile.git"
git branch -M main
...
if errorlevel 1 (
  echo.
  echo --- 실패했을 때 확인 ---
  echo 1) GitHub 에 imseungjun-profile 저장소가 이미 만들어졌는지
...
echo.
echo ========================================
echo  완료. 저장소: https://github.com/imseungjun/imseungjun-profile
echo  Pages: Settings - Pages - Source: GitHub Actions 선택 후
echo  주소: https://imseungjun.github.io/imseungjun-profile/
echo ========================================
echo.
pause
